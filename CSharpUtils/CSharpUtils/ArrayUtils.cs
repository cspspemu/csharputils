...
namespace CSharpUtils
{
	static public class ArrayUtils
	{
		...
		static public T[] Concat<T>(this T[] Left, T[] Right, int Offset, int Length)
		{
			var Return = new T[Left.Length + Length];
			Left.CopyTo(Return, 0);
			Array.Copy(Right, Offset, Return, Left.Length, Length);
			return Return;
		}
